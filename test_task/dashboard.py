...
And to activate the app index dashboard::
    ADMIN_TOOLS_APP_INDEX_DASHBOARD = 'test_task.dashboard.CustomAppIndexDashboard'
"""
...
class CustomIndexDashboard(Dashboard):
    """
    Custom index dashboard for test_task.
    """
    columns = 1
...
class CustomAppIndexDashboard(AppIndexDashboard):
    """
    Custom app index dashboard for test_task.
    """
